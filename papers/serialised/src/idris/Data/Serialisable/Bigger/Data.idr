module Data.Serialisable.Bigger.Data
...
import Lib
import Data.Serialisable.Bigger.Desc
...
namespace Data
  ...
  curry (Val d) f = f
  curry (Prd d e) f
    = Data.Data.curry d {a = AllK e p (snd t) a}
    $ \ v => Data.Data.curry e
...
namespace Serialising
  ...
  setMuK cs (MkIndex k) with (index k $ constructors cs)
    _ | cons = Data.Data.curry (description cons) $ \ layer =>

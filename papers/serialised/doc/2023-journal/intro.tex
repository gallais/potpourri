...
one computed by the pure \IdrisFunction{sum} function. And so we can
transfer any property proven on the pure \IdrisFunction{sum} to the
...
defined and prove the functional correctness of the \IdrisType{IO}

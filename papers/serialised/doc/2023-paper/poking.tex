...
We can now describe the combinators allowing our users to inspect the
content of a buffer. We will start from the most basic of building blocks
and ultimately combine them to implement a generic correct-by-construction

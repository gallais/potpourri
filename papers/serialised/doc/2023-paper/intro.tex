...
\begin{center}
  \usestt
    ...
    \IdrisData{0a} 01 00 \IdrisData{14} 00}m
\end{center}
...
%% and indeed running \texttt{sumAt} over a buffer containing
%% \texttt{01 01 01 00 \IdrisData{01} 00 \IdrisData{05} 00 \IdrisData{0a} 01 00 \IdrisData{14} 00}
%% correctly returns $36$.

...
%
Both involve a choice in the form of a \IdrisType{Bool} value:
...
(co)inductive protocols. These reveal the role of \IdrisType{Channel}'s
...
the client to choose one of the branches we \IdrisFunction{offer}.
If they're done we \IdrisFunction{close} the channel and terminate,
...
accumulator \IdrisBound{acc}. We \IdrisFunction{unroll} the smallest
...
and \todo{continue}.
%
Otherwise we \IdrisFunction {recv} an additional number, add it to the accumulator

...
\begin{tikzpicture}[tpstyle]
  \draw<5>[arrow,->] ([yshift=-2pt, xshift=-20pt]xorabb.south) to[bend right] +(+1,-2.5) node[anchor=west]
       {\hand $xor(xor(a,b),b)$ equals $a$};
  \draw<8>[arrow,->] ([yshift=-2pt]xoraba.south) to[bend right] +(+2.5,-1) node[anchor=west]

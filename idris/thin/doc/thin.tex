...
A right shift will add \IdrisBound{k} new least significant bits initialised
at \IdrisBound{0}; consequently testing a bit \IdrisBound{i} on the left-shifted
integer will either return \IdrisData{0} if \IdrisBound{i} is strictly less than

...
comparison between \IdrisFunction{head} and \IdrisFunction{tail}.
%
We have left a empty line in the definition of the former to line up each
equation with the matching one in the latter.

\begin{minipage}[t]{0.45\textwidth}
\ExecuteMetaData[Snoc.idr.tex]{head}
\end{minipage}

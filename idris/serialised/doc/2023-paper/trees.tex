...
%
Correspondingly, this standard semantics does not make any use
of the invariants that our \IdrisType{Desc} tracks.

In our work these trees will be used primarily to allow users to
give a precise specification of the functions they actually want to
write on values stored in buffers.
%
We expect these trees to be mostly used at the \IdrisKeyword{0}

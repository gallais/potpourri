...
datatypes by performing induction on the type of codes.
...
%
Second, the statically known \IdrisBound{size} of the described data
...
and the values of the \IdrisFunction{size} and
